...
# Prompt Melhorado
Explique o que é Engenharia de Prompts para iniciantes e forneça exemplos práticos.
Resultado:
Resposta mais detalhada e de fácil compreensão.

# Prompt Avançado
Atue como professor especialista em Inteligência Artificial e explique Engenharia de Prompts utilizando exemplos do cotidiano.
Resultado:
...
# Resumo do Tema
A Engenharia de Prompts consiste na elaboração de instruções claras e objetivas para obter respostas mais precisas de modelos de Inteligência Artificial.
Quanto melhor o contexto fornecido, maior tende a ser a qualidade das respostas produzidas pela IA.
...
# Prompt
Instrução fornecida para a IA gerar uma resposta.
# Token
Unidade básica utilizada pelo modelo para processar textos.
# Contexto
